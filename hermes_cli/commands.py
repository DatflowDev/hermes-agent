...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("agents", "Show active agents, running tasks, or profile definitions", "Session",
               aliases=("tasks",), args_hint="[definitions|show <name>]",
               subcommands=("definitions", "show"), busy_policy="dispatch"),
